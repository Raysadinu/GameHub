    ...
    <div class="categories-container">
        <form method="get" action="${pageContext.request.contextPath}/Filter">
            <div class="dropdown" style="padding-right: 20px">
                <button class="dropdown-toggle" type="button" id="categoriesDropdown" aria-haspopup="true" aria-expanded="false">
                    Categories
                </button>
            ...
            <div class="dropdown" style="padding-right: 20px">
                <button class="dropdown-toggle" type="button" id="filterDropdown" aria-haspopup="true" aria-expanded="false">
                    Price
                </button>
